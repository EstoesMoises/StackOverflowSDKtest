...
------------- | ------------- | -------------
[**questionsGet**](QuestionsMain2Api.md#questionsGet) | **GET** /questions | Retrieve all questions
...
```typescript
import { createConfiguration, QuestionsMain2Api } from '';
import type { QuestionsMain2ApiQuestionsGetRequest } from '';

const configuration = createConfiguration();
const apiInstance = new QuestionsMain2Api(configuration);

const request: QuestionsMain2ApiQuestionsGetRequest = {
